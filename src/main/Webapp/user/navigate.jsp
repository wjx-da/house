...
<div id="index_head">
    <div id="logoInfo">
        <div id="address">
            <img id="addressimg" src="images/jkf_imgs/address.svg" alt="苏州">
            <span>当前城市[<span id="addresssp"></span>]</span>
        </div>
        <ul id="home">
            <li><a href="/">首页</a></li>
            <li><a href="/job/jobInfo">职位</a></li>
        </ul>
        <c:if test="${sessionScope.loginCustomer==null}">
            <div class="loginPart">
                <ul>
                    ...
                    <li>
                        <a href="/login" class="clickBtn">登录</a>
                    </li>
                    <li>
                        <a href="/register" class="clickBtn">注册</a>
                    </li>
                </ul>
            </div>
        </c:if>
        <c:if test="${sessionScope.loginCustomer!=null}">
            <div class="loginPart">
                <ul>
                    <li>
                        <a href="/customer/center/2">投递记录</a>
                    </li>
                    <li>
                        <a href="/customer/center/1">简历</a>
                    </li>
                    <li>
