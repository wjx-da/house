...
let registerMsg = document.querySelector("#registerMsg");// 注册失败消息提示框
  phoneType1 = -1; // 手机号 flag 手机号/邮箱类型标记 - 0手机号；1邮箱
...
function checked() {
    if ((phoneType1 > -1) && codeType && pwdType && rePwdType) {
...
sendCodeBtn.onclick = function () {
    ...
    let sendContent = "email=" + phoneIpt.value.trim() + "&type=" + phoneType1;//去空格，把用户的邮箱传过去
...
registerBtn.onclick = function () {
    ...
    let sendContent = inputContent + '&other2=' + phoneType1;
